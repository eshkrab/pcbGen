...
void eagleFile::writeLib(){
  for(vector<string>::iterator it = libraries.begin(); it!=header.end(); ++it){
    write_buff.append(*it);
  }

}
void eagleFile::writeMidFile(){
  for(vector<string>::iterator it = mid_file.begin(); it!=header.end(); ++it){
    write_buff.append(*it);
  }
}
...
void eagleFile::writeFooter(){
  for(vector<string>::iterator it = footer.begin(); it!=header.end(); ++it){
    write_buff.append(*it);
  }
